        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
              <div className="relative aspect-[4/5] max-w-[420px] mx-auto group">
                ...
                <div className="absolute -inset-10 bg-gradient-to-tr from-white/10 to-transparent blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                ...
                >
                  <div className="flex items-center gap-8">
                    <div>
                      ...
                      <p className="text-[10px] uppercase font-black text-white/50 tracking-[0.2em]">Years Exp.</p>
                    </div>
                    <div className="w-[1px] h-12 bg-white/10" />
                    <div>
                      <h4 className="text-4xl font-black text-white font-display">15+</h4>
                      <p className="text-[10px] uppercase font-black text-white/50 tracking-[0.2em]">Projects</p>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span className="text-white/50 text-xs font-black tracking-[0.4em] uppercase">Who I am</span>
                </div>
                ...
                <div className="space-y-8 text-neutral-400 text-lg leading-relaxed mb-16">
                  <p className="border-l-2 border-white/10 pl-8 italic">
